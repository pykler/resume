...
\section{EXPERIENCE}
    ...
    \begin{itemize}  \itemsep -2pt % reduce space between items
     ...
     \item {\bf Technologies:} \hspace{1pt}
        Python, Django, HTML/JS, Angular, CoffeeScript, NodeJS, \newline
        \hspace*{72pt} Scala, NLTK, NLP, Mongo, Postgres, Neo4J, Redis, Puppet, \newline
        \hspace*{72pt} Mercurial, Unix, Debian, Puppet, ProxMox, Cloud ...
    \end{itemize}
